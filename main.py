...
USERNAME = config('USERNAME', default='pk612')
BOTNAME = config('BOTNAME', default='Techboi Ai')
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if 'open notepad' in query:
            ...
            speak(f"Some of the trending movies are:")
            speak(', '.join(trending))
            speak("For your convenience, I am printing it on the screen sir.")
            print(*trending, sep='\n')
            ...
            speak("Initiating self-termination. Goodbye, sir!")
            break  
